...
@interface LLMenuButton ()

@property (nonatomic, strong) LLGlowImageView *iconImageView;
@property (nonatomic, strong) UILabel *titleLabel;

@property (nonatomic, strong) LLMenuItem *menuItem;

@end

@implementation LLMenuButton

- (instancetype)initWithFrame:(CGRect)frame menuItem:(LLMenuItem *)menuItem {
    self = [super initWithFrame:frame];
    if (self) {
        // Initialization code
        self.menuItem = menuItem;
        
        self.iconImageView = [[LLGlowImageView alloc] initWithFrame:CGRectMake(0, 0, menuItem.iconImage.size.width, menuItem.iconImage.size.height)];
