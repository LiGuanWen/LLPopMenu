...
typedef NS_ENUM(NSInteger, LLPopupMenusAnimationType) {
    /** 从下部入 下部出*/
    kLLPopupMenusAnimationTypeSina = 0,
    /** 从右侧入 左侧出*/
    kLLPopupMenusAnimationTypeNetEase = 1,
};
 ...
 */
typedef void(^DidSelectedItemBlock)(LLMenuItem *selectedItem);

// ==========================================
//  LLPopupMenus 菜单栏
// ==========================================
@interface LLPopupMenus : UIView

/**
 *  菜单动画格式
 */
@property (nonatomic, assign) LLPopupMenusAnimationType menuAnimationType;
 ...
 *
 *  此效果用于 在 LLPopupMenus AnimationType 为 kLLPopupMenusAnimationTypeNetEase 有效，
